...
function CmacsCompactTableComponent_ng_template_6_cmacs_select_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("dropdownRender", ctx_r305.getDropdownAddOptionTemplateRef(field_r299))("cmacsEditable", ctx_r305.isSelectCustom(field_r299))("placeHolder", field_r299.placeholder ? field_r299.placeholder : "")("mode", field_r299.mode ? field_r299.mode : "default")("showCmacsSearch", field_r299.showCmacsSearch)("ngModel", data_r300[field_r299.property]);
    i0.ɵɵadvance(2);
...
export class CmacsCompactTableComponent {
    ...
    isSelectCustom(field) {
        return field !== undefined && field.celdType === CeldType.Default && field.editTemplate === TemplateType.SelectAddOption;
    }
    isString(field) {
    ...
    getDropdownAddOptionTemplateRef(field) {
        if (field !== undefined && field.celdType === CeldType.Default && field.editTemplate === TemplateType.SelectAddOption) {
            return this.dropdownAddOptionTemplateRef;
        }
    }
    ngAfterViewInit() {
