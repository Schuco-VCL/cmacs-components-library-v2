...
function CmacsCompactTableComponent_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(3, CmacsCompactTableComponent_ng_template_6_cmacs_select_3_Template, 3, 7, "cmacs-select", 83);
