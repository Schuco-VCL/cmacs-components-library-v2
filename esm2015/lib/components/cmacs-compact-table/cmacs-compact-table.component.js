...
function CmacsCompactTableComponent_ng_template_6_cmacs_date_picker_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("allowClear", true)("ngModel", data_r268[field_r267.property]);
} }
...
function CmacsCompactTableComponent_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(1, CmacsCompactTableComponent_ng_template_6_cmacs_date_picker_1_Template, 2, 4, "cmacs-date-picker", 86);
