...
CmacsTreeComponent.ɵcmp = i0.ɵɵdefineComponent({ type: CmacsTreeComponent, selectors: [["cmacs-tree"]], contentQueries: function CmacsTreeComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, directives: [i3.NgClass, i3.NgForOf, i4.CmacsTreeNodeComponent], styles: ["[_nghost-%COMP%]     .ant-select-tree li ul, [_nghost-%COMP%]     .ant-tree li ul{padding:0!important}[_nghost-%COMP%]     .ant-select-tree .cmacs-tree-child-header, [_nghost-%COMP%]     .ant-select-tree .cmacs-tree-parent-header{box-shadow:inset 0 1px 0 #dee0e5;padding-top:3px;padding-bottom:3px}[_nghost-%COMP%]     .ant-select-tree .cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-select-tree .cmacs-tree-parent-header:hover{background-color:#f2f7ff}[_nghost-%COMP%]     .ant-select-tree .cmacs-tree-parent-header{padding-left:10px!important}[_nghost-%COMP%]     .ant-select-tree li{margin:0;font-family:Roboto-Regular;font-size:12px!important;font-weight:400;font-stretch:normal;font-style:normal;line-height:1.33;letter-spacing:normal;color:#656c79}  .font-highlight{color:#2a7cff!important}[_nghost-%COMP%]     .ant-select-tree-switcher_close{color:#dee0e5}[_nghost-%COMP%]     .ant-select-tree li .ant-select-tree-node-content-wrapper:hover{background-color:transparent}.ant-tree[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] > div[_ngcontent-%COMP%]{display:inline-flex;top:3px}.ant-tree[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]{line-height:1.3!important}.ant-tree[_ngcontent-%COMP%], .ant-tree[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;min-width:100%}.custom-node[_ngcontent-%COMP%], .custom-node[_ngcontent-%COMP%] > span[_ngcontent-%COMP%]{display:inline-flex}.ant-tree-treenode-switcher-close[_ngcontent-%COMP%] > div[_ngcontent-%COMP%], .ant-tree-treenode-switcher-open[_ngcontent-%COMP%] > div[_ngcontent-%COMP%]{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;min-width:100%}[_nghost-%COMP%]     .ant-tree li span.ant-tree-switcher.ant-tree-switcher_close .ant-select-switcher-icon, [_nghost-%COMP%]     .ant-tree li span.ant-tree-switcher.ant-tree-switcher_close .ant-tree-switcher-icon{color:#bec4cd}[_nghost-%COMP%]     .ant-tree li{font-size:12px;font-weight:400;font-style:normal;font-stretch:normal;line-height:1.67;letter-spacing:normal;color:#656c79}[_nghost-%COMP%]     .ant-tree li .ant-tree-node-content-wrapper.ant-tree-node-selected, [_nghost-%COMP%]     .ant-tree li .ant-tree-node-content-wrapper:hover{background-color:transparent}[_nghost-%COMP%]     .ant-tree .cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-tree .cmacs-tree-parent-header:hover{background-color:#f6f7fb}[_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked:hover, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected:hover{background-color:#f2f7ff}[_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked.cmacs-tree-child-header, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked .cmacs-tree-node-selected, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked .cmacs-tree-parent-header, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected.cmacs-tree-child-header, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected .cmacs-tree-node-selected{webkit-box-shadow:inset 2px 0 0 0 #2a7cff,inset 0 1px 0 transparent,inset 0 -1px 0 transparent!important;box-shadow:inset 2px 0 0 0 #2a7cff,inset 0 1px 0 transparent,inset 0 -1px 0 transparent!important}[_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked.cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked .cmacs-tree-node-selected:hover, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked .cmacs-tree-parent-header:hover, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected.cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected .cmacs-tree-node-selected:hover{background-color:#f2f7ff}[_nghost-%COMP%]     .ant-tree li.ant-tree-treenode-checkbox-checked .ant-tree-child-tree, [_nghost-%COMP%]     .ant-tree li.ant-tree-treenode-selected .ant-tree-child-tree{background-color:#f6f7fb}[_nghost-%COMP%]     .ant-tree .ant-tree-treenode-checkbox-checked.cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-tree .ant-tree-treenode-selected.cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-tree .cmacs-tree-node-selected:hover{box-shadow:inset 2px 0 0 0 #2a7cff,inset 0 1px 0 #dee0e5,inset 0 -1px 0 #dee0e5!important}[_nghost-%COMP%]     .ant-tree li{padding:0}[_nghost-%COMP%]     .ant-tree:not(.ant-select-tree) .cmacs-tree-child-header, [_nghost-%COMP%]     .ant-tree:not(.ant-select-tree) .cmacs-tree-parent-header{box-shadow:inset 0 1px 0 transparent,inset 0 -1px 0 transparent;padding-top:3px;padding-bottom:3px}[_nghost-%COMP%]     .ant-tree .cmacs-tree-node-selected~ul cmacs-tree-node .cmacs-tree-child-header:hover, [_nghost-%COMP%]     .ant-tree .cmacs-tree-node-selected~ul cmacs-tree-node .cmacs-tree-parent-header:hover{box-shadow:inset 0 1px 0 #dee0e5,inset 0 -1px 0 #dee0e5!important}[_nghost-%COMP%]     .ant-tree li.ant-tree-treenode-disabled>div>span:last-child{color:#acb3bf}[_nghost-%COMP%]     .ant-tree li.drag-over, [_nghost-%COMP%]     .ant-tree li.drag-over-gap-bottom, [_nghost-%COMP%]     .ant-tree li.drag-over-gap-bottom.cmacs-tree-child-header{box-shadow:inset 0 -1px 0 #2a7cff}[_nghost-%COMP%]     .ant-tree li.drag-over-gap-top, [_nghost-%COMP%]     .ant-tree li.drag-over-gap-top.cmacs-tree-child-header{box-shadow:inset 0 1px 0 #2a7cff}[_nghost-%COMP%]     .ant-tree li span.ant-tree-switcher{position:relative;z-index:1}  .cmacs-context-menu-overlay{position:absolute;top:0;left:0;width:100%;height:100%}  .ant-tree-switcher{position:relative;width:24px;display:inline-block;margin:0;cursor:pointer;line-height:unset}"], changeDetection: 0 });
__decorate([
    InputBoolean()
