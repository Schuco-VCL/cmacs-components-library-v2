...
CmacsListComponent.ɵfac = function CmacsListComponent_Factory(t) { return new (t || CmacsListComponent)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.Directionality, 8)); };
CmacsListComponent.ɵcmp = i0.ɵɵdefineComponent({ type: CmacsListComponent, selectors: [["cmacs-list"], ["", "cmacs-list", ""]], contentQueries: function CmacsListComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        i0.ɵɵcontentQuery(dirIndex, CmacsListFooterComponent, 1);
        i0.ɵɵcontentQuery(dirIndex, CmacsListPaginationComponent, 1);
        i0.ɵɵcontentQuery(dirIndex, CmacsListLoadMoreDirective, 1);
    } if (rf & 2) {
        let _t;
    ...
    } }, directives: [i2.NgIf, i3.NzSpinComponent, i2.NgTemplateOutlet, i2.NgForOf, i4.CmacsListHeaderComponent, i5.NzStringTemplateOutletDirective, i6.NzRowDirective, i6.NzColDirective, i4.CmacsListEmptyComponent, i4.CmacsListFooterComponent, i4.CmacsListPaginationComponent], styles: [".cmacs-classic-grid{display:inline-block}.ant-list-grid .ant-list-item{margin-bottom:40px}"], encapsulation: 2, changeDetection: 0 });
__decorate([
    InputBoolean()
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CmacsListComponent, [{
        type: Component,
        args: [{
                selector: 'cmacs-list, [cmacs-list]',
                exportAs: 'cmacsList',
