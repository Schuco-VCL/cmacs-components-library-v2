...
export class CmacsCompactTableComponent {
    ...
    setCustomValidators() {
        ...
        if (this.config.fields === undefined || this.config.fields === null) {
            return;
        }
