...
export declare class CmacsKpiGroupTotalComponent implements OnInit, AfterViewInit, OnChanges {
    ...
    getChartImage(): any;
    static ɵfac: i0.ɵɵFactoryDeclaration<CmacsKpiGroupTotalComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CmacsKpiGroupTotalComponent, "cmacs-kpi-group-total", never, { "headerText": { "alias": "headerText"; "required": false; }; "footerText": { "alias": "footerText"; "required": false; }; "footerValue": { "alias": "footerValue"; "required": false; }; "view": { "alias": "view"; "required": false; }; "data": { "alias": "data"; "required": false; }; "columnsHeader": { "alias": "columnsHeader"; "required": false; }; }, { "clickMenu": "clickMenu"; }, never, never, false, never>;
}
